...
//StereoCube::StereoCube(const std::vector<QVector4D>  origin)
//{
//    type = SceneObjectType::ST_STEREO_CUBE;
...
//void StereoCube::affineMap(const QMatrix4x4& M)
//{
//}


//void StereoCube::draw(const RenderCamera& renderer, const QColor& color, float lineWidth) const
//{
//    QColor c = color;
//    c.toHsv();
