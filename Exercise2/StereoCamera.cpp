        ...
        float lineWidth)
{
    ...
    for (auto tuple : this->projectCubes) {
        ...
        for (unsigned int i = 0; i < leftProjection.size(); i++) {
            ...
            float x =  z * ( leftPoint.x() / focalDistance );

            QVector4D pointCreated = QVector4D(x, y, z, 1);

            renderer.renderLine(rightCameraOrigin, QVector4D(4, 4, 10, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(0, 4, 10, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(4, 1, 10, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(0, 1, 10, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(4, 4, 14, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(0, 4, 14, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(4, 1, 14, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(0, 1, 14, 1),QColor(255,255,0), 1.0);

            renderer.renderLine(leftCameraOrigin, QVector4D(4, 4, 10, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(0, 4, 10, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(4, 1, 10, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(0, 1, 10, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(4, 4, 14, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(0, 4, 14, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(4, 1, 14, 1),QColor(255,255,0), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(0, 1, 14, 1),QColor(255,255,0), 1.0);

            result.push_back(pointCreated);


            renderer.renderLine(leftCameraOrigin, QVector4D(12, 2, 5, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(10, 2, 5, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(12, 1, 5, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(10, 1, 5, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(12, 2, 7, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(10, 2, 7, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(12, 1, 7, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(leftCameraOrigin, QVector4D(10, 1, 7, 1),QColor(255,0,255), 1.0);

            renderer.renderLine(rightCameraOrigin, QVector4D(12, 2, 5, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(10, 2, 5, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(12, 1, 5, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(10, 1, 5, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(12, 2, 7, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(10, 2, 7, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(12, 1, 7, 1),QColor(255,0,255), 1.0);
            renderer.renderLine(rightCameraOrigin, QVector4D(10, 1, 7, 1),QColor(255,0,255), 1.0);
